...
def render_pipeline_bar(df):
    ...
    # Render as a single HTML block + one row of hidden buttons below
    blocks = []
    for stage in STAGE_ORDER:
        ...
        zero_style = "opacity:0.3;" if count == 0 and not active else ""
        blocks.append(
    ...
    # Hidden button row for click handling
